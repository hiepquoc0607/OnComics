...
public partial class OnComicsDatabaseContext : DbContext
{
    ...
    public virtual DbSet<Favortite> Favortites { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Favortite>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("favortite");

            entity.HasIndex(e => e.AccountId, "AccountId");

            entity.HasIndex(e => e.ComicId, "ComicId");

            entity.HasOne(d => d.Account).WithMany(p => p.Favortites)
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("favortite_ibfk_1");

            entity.HasOne(d => d.Comic).WithMany(p => p.Favortites)
                .HasForeignKey(d => d.ComicId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("favortite_ibfk_2");
        });
